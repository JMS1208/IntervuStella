...
val bright_purple = Color(0xFFB924FF)
val bright_blue = Color(0xFF4B5DFF)
val dim_sky_blue = Color(0xFF76B8FF)
val dim_red = Color(0xFFC40000)
val highlight_yellow = Color(0xFFFFC107)
val bg_grey = Color(0xFFEBEFF3)
val bg_mono_grey = Color(0xFFF3F3F3)
val highlight_red = Color(0xFFFF5151)
val highlight_blue = Color(0xA14B5DFF)
val highlight_green = Color(0xFF88D194)
val unselected_grey = Color(0xFFD8D8D8)
val shadow_color = Color(0x6F000000)
val text_blue = Color(0xFF0078ff)
//val bg_little_darker_grey = Color(0xFFEBEFF3)
val bright_sky_blue = Color(0xFF12C2E9)
val bright_violet = Color(0xFFC471ED)
val bg_darker_gray = Color(0xFF979DA5)
val mustard_yellow = Color(0xFFFFCA43)
val text_sharp_blue = Color(0xFF0047FF)
val text_red = Color(0xFFFF2B2B)
val orange_yellow = Color(0xFFFF9900)
val deep_darker_blue = Color(0xFF003A7B)
val darker_blue = Color(0xFF2737C5)
val bright_pink = Color(0xFFFF8E8E)
val bright_white_blue = Color(0xFF9CE8FF)